class MonetizeAllTheThings < ActiveRecord::Migration
  def change
    ...
    add_money :invoices, :subtotal
    add_money :invoices, :total
    add_money :invoices, :paid_amount
    ...
    add_money :line_items, :subtotal
    add_money :line_items, :total
    add_money :line_items, :price_per_item
    add_money :line_items, :price_per_item_with_discount
