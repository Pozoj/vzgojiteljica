...
ActiveRecord::Schema.define(version: 20_161_119_230_649) do
  ...
  add_index 'authorships', %w(author_id article_id), name: 'index_authorships_on_author_id_and_article_id', unique: true, using: :btree
  ...
  add_index 'keywordables', %w(article_id keyword_id), name: 'index_keywordables_on_article_id_and_keyword_id', unique: true, using: :btree
  add_index 'keywordables', ['article_id'], name: 'index_keywordables_on_article_id', using: :btree
  add_index 'keywordables', %w(keyword_id article_id), name: 'index_keywordables_on_keyword_id_and_article_id', unique: true, using: :btree
  ...
  add_index 'receipts', %w(payment_id type), name: 'index_receipts_on_payment_id_and_type', unique: true, using: :btree
  add_index 'receipts', %w(receipt_id type), name: 'index_receipts_on_receipt_id_and_type', unique: true, using: :btree
